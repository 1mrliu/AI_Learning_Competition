...
def programmer_3():
    ...
    data1 = pd.read_csv(inputfile1, encoding="utf8", header=None,engine='python')
    data2 = pd.read_csv(inputfile2, encoding="utf8", header=None,engine='python')
    # 利用正则去除一些数据
...
def programmer_5():
    ...
    pos_lda = models.LdaModel(pos_corpus, num_topics=3, id2word=pos_dict, chunksize=100)
    for i in range(3):
