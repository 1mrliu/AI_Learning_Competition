...
path = 'D:/Users/sangfor/Desktop/TextInfoExp-master/TextInfoExp-master/Part1_TF-IDF/data/computer/' # 原始数据
path1 = 'D:/Users/sangfor/Desktop/TextInfoExp-master/TextInfoExp-master/Part1_TF-IDF/data/title_and_abs/'  # 处理后的标题和摘要
newpath = 'D:/Users/sangfor/Desktop/TextInfoExp-master/TextInfoExp-master/Part1_TF-IDF/data/pro_keyword/'
newpath2 = 'D:/Users/sangfor/Desktop/TextInfoExp-master/TextInfoExp-master/Part1_TF-IDF/data/keyword/'
...
def get_text():
    ...
    for files in filelist:
        ...
        if b is None or b.string is None:
            ...
            s = b.string
            abstracts.extend(s)
            f = codecs.open(path1 + filename + ".txt", "w+", 'utf-8')  # 写入txt文件
            for i in abstracts:
                f.write(i)
            f.close()
            abstracts = []
